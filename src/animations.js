...
function transitionProperty(element, property, transitionSpeed, targetValue) {
    return new Promise((resolve) => {
        ...
        if (element.style[property] != targetValue) {
            element.style.transition = `${property} ${transitionSpeed}`;
...
export { delay, transitionProperty, fade, fadeInnerText, fadeBackgroundImage };
